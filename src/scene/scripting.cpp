...
std::unique_ptr<Camera> Scripting::createScriptedCamera(glm::vec3 pos, glm::vec3 rot) {
    ...
    std::vector<MOVE> keyframe1 = {{0.0, 3000.0, glm::vec3(29.76, 5.42, -0.18), glm::vec3(8.54,0.09,-1.12)}};
    std::vector<MOVE> keyframe2 = {{0.0, 3000.0, glm::vec3(17.62,12.75,0.54), glm::vec3(8.54,6.34,-1.12)}};
    std::vector<MOVE> keyframe3 = {{0.0, 3000.0, glm::vec3(8.48,3.95,3.45), glm::vec3(8.54,3.16,-1.69)}};
    std::vector<MOVE> keyframe4 = {{0.0, 3000.0, glm::vec3(-10.08,3.95,-2.78), glm::vec3(-11.44,3.16,-1.69)}};
    std::vector<MOVE> keyframe5 = {{0.0, 10000.0, glm::vec3(-13.26,20.09,6.43), glm::vec3(-9.88,13.87,22.26)}};
    std::vector<MOVE> keyframe6 = {{0.0, 3000.0, glm::vec3(-8.99,24.69,-6.15), glm::vec3(4.22,21.46,0.49)}};
    std::vector<MOVE> keyframe7 = {{0.0, 15000.0, glm::vec3(-8.99,1.50,-6.15), glm::vec3(-0.12,-1.02,1.36)}};
    std::vector<MOVE> keyframe8 = {{0.0, 3000.0, glm::vec3(-8.99,1.50,-6.15), glm::vec3(-20.59,-1.02,1.36)}};
    std::vector<MOVE> keyframe9 = {{0.0, 7000.0, glm::vec3(0.49,1.50,-6.32), glm::vec3(-20.59,-1.02,1.36)}};
